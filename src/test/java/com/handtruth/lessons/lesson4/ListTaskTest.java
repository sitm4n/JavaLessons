...
class ListTaskTest {
    ...
    void positiveCounter() {
        assertEquals(0, listTask.positiveCounter(new ArrayList<>()));
    ...
    @Test
    @Tag("Hard")
    void longestTrueSequence() {
        assertEquals(5,
                listTask.longestTrueSequence(
        ...
        assertEquals(3,
                listTask.longestTrueSequence(Arrays.asList(true, true, true, false, false, true, false, true, true))
        );
